...
<body>
	<div id="wrapper" style="height: 100%;">
        ...
        <div id="page-wrapper" style="height: 80%;">
            <table id="pcategory"  title="标本分类树" fit="true"
		            data-options="
		                url: '<c:url value="/pcategory/category"/>',
		                method:'get',
		                rownumbers: true,
		                pagination: true,
		                pageSize: 10,
    		...
    		<div id="tb" style="padding:2px 5px;">
			  <button type="button" class="btn btn-primary" style="height: 28px;padding: 0 6px;" id="pcAdd">
			  	<span class="glyphicon glyphicon-plus"></span> 增加
			  </button>
			  <button type="button" class="btn btn-primary" style="height: 28px;padding: 0 6px;" id="pcEdit">
		  	  	<span class="glyphicon glyphicon-pencil"></span> 修改
			  </button>
			  <button type="button" class="btn btn-primary" style="height: 28px;padding: 0 6px;" id="pcCheck">
		  	  	<span class="glyphicon glyphicon-search"></span> 查看
			  </button>
			  <button type="button" class="btn btn-primary" style="height: 28px;padding: 0 6px;" id="pcDel">
		  	  	<span class="glyphicon glyphicon-remove"></span> 删除
			  </button>
			  <select id="pcSearchKey" class="form-control"  style="width: 15%;display: inline;vertical-align: middle;">
                <option value="class_name">类别中文名</option>
                <option value="class_latin">类别拉丁名</option>
              </select>
			  <input type="text" id="pcSearchValue" class="form-control" placeholder="查询..." style="width: 20%;display: inline;vertical-align: middle;">
              <button id="pcSearch" class="btn btn-default" type="button">
    ...
    <!-- 显示标本类别信息 -->
	<div class="modal fade" id="plantsCategryInfo" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none;">
          <div class="modal-dialog">
              <div class="modal-content">
                  ...
                  <div class="modal-body">
                  	  <form id="pcAdd" class="basic-grey">
						<label>
						<span>父类别 :</span>
						</label>
    ...
    <script type="text/javascript" src="<c:url value="/resources/js/plants/pCategoryOp.js"/>"></script>
    ...
    $(function(){
    	...
    	$("#pcSearch").click(function(){
    		var key = $('#pcSearchKey').val();
    		var value = $('#pcSearchValue').val();
    		var data = {};
    		if(value == ''){
    			key = 'parent_id';
    			value = 0;
